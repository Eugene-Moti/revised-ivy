...
export default function Home() {
  ...
  <a href="#" className="font-semibold text-xl bg-gold text-black px-7 py-2 rounded-lg shadow hover:bg-[#bfa14a] hover:text-white transition whitespace-nowrap min-w-[170px] text-center border-2 border-gold">Explore Properties</a>
  <a href="#" className="font-semibold text-xl bg-gold text-black px-7 py-2 rounded-lg shadow hover:bg-[#bfa14a] hover:text-white transition whitespace-nowrap min-w-[170px] text-center border-2 border-gold">Book Viewing</a>
      </div>
      <style jsx global>{`
        .hero-glow-text {
